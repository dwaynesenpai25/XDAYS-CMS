...
if uploaded_file is not None:
    ...
    for date, group in df.groupby(df['Date'].dt.date):
        accounts = group[(group['Remark Type'] == 'Predictive') & (group['Remark By'] == 'SYSTEM')]['Account No.'].nunique()
        total_dialed = group[(group['Remark Type'] == 'Predictive') & (group['Remark By'] == 'SYSTEM')]['Account No.'].count()
